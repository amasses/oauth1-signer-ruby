...
class TestGetSignatureBaseString < Minitest::Test
  ...
  def test_creates_a_correctly_constructed_and_escaped_signature_base_string
    ...
    sbs = Mastercard::OAuth.get_signature_base_string(http_method, base_uri, param_string)
  ...
  def test_creates_a_correctly_constructed_and_escaped_signature_base_string_given_encoded_params
    ...
    query_params = Mastercard::OAuth.extract_query_params'https://example.com/?param=token1%3Atoken2'
    oauth_params = Mastercard::OAuth.get_oauth_params consumer_key
    param_string = Mastercard::OAuth.to_oauth_param_string query_params, oauth_params

    sbs = Mastercard::OAuth.get_signature_base_string(http_method, "https://example.com", param_string)
    ...
    def test_creates_a_correctly_constructed_and_escaped_signature_base_string_given_decoded_params
      ...
      query_params = Mastercard::OAuth.extract_query_params'https://example.com/?param=token1:token2'
      oauth_params = Mastercard::OAuth.get_oauth_params consumer_key
      param_string = Mastercard::OAuth.to_oauth_param_string query_params, oauth_params
