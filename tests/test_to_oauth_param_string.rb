  ...
  def test_creates_a_correctly_encoded_and_sorted_OAuth_parameter_string
    ...
    Mastercard::OAuth.stub(:get_nonce, 'uTeLPs6K') do
      Mastercard::OAuth.stub(:time_stamp, '1524771555') do
        query_params = Mastercard::OAuth.extract_query_params 'HTTPS://SANDBOX.api.mastercard.com/merchantid/v1/merchantid?MerchantId=GOOGLE%20LTD%20ADWORDS%20%28CC%40GOOGLE.COM%29&Format=XML&Type=ExactMatch&Format=JSON'
